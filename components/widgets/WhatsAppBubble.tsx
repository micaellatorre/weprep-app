...
const WhatsAppBubble: React.FC = () => {
    return (
        <Link
            className="bg-gradient-to-br from-green-400 to-green-600 rounded-[15px] fixed right-[20px] bottom-[40px] shadow-[0px_0px_10px_rgba(48,40,6,0.2)] h-[55px] w-[55px] transition-all z-50 duration-300 hover:h-[65px] hover:w-[65px]"
